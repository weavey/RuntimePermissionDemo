                ...
                if (ContextCompat.checkSelfPermission(context, Manifest.permission.CALL_PHONE) ==
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this,
                        ...
                        new NormalAlertDialog.Builder(context).setContentText
                                ("由于您拒绝了拨号权限授权，导致该功能不可使用，是否重新授权？")
                                .setLeftButtonText("我就不").setRightButtonText("重新授权")
                                .setOnclickListener(new DialogInterface
                                        .OnLeftAndRightClickListener<NormalAlertDialog>() {


                                    @Override
                                    public void clickLeftButton(NormalAlertDialog dialog, View
                                            view) {
                                    ...
                                    @Override
                                    public void clickRightButton(NormalAlertDialog dialog, View
                                            view) {
                        ...
                        if (isFirstRequest) {
                            ...
                            new NormalAlertDialog.Builder(context).setContentText
                                    ("发现您拒绝了授权拨号权限且不再提示，将导致该功能不可用，是否前往设置授权？。")
                                    .setLeftButtonText("我就不").setRightButtonText("去设置")
                                    .setOnclickListener(new DialogInterface
                                            .OnLeftAndRightClickListener<NormalAlertDialog>() {
